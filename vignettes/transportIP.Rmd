...
result <- transportIP(msmFormula = sysBloodPressure ~ med1,
...
We can also create some plots to assess the correctness of the propensity and participation models, as well as plots showing the confidence intervals for the model coefficients.

```{r IPWeighting-Plots, echo = T}
